<div class="container mx-auto px-4 py-10 sm:px-6 lg:px-8">
  ...
  <div
    class="mx-auto max-w-5xl rounded-xl border border-gray-200 bg-white p-8 shadow-md dark:border-gray-700 dark:bg-gray-800">
      ...
      <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div class="space-y-6">
          ...
          <button type="button" wire:click="cancelOrder"
            class="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-3 text-center text-sm font-semibold text-gray-700 transition-all duration-200 hover:bg-gray-100 active:scale-[0.98] dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600">
            Batal Pesanan
          </button>

          <a href="{{ route('cart') }}" wire:navigate
            class="inline-block cursor-pointer text-sm text-gray-600 hover:underline dark:text-gray-400">
