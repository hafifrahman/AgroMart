<div>
  <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          @forelse ($products as $product)
            <tr>
              ...
              <td class="flex whitespace-nowrap px-6 py-4 text-sm font-medium">
                <a href="{{ route('admin.product.edit', $product) }}" wire:navigate
    ...
    <div
      class="{{ $showAddProductModal ? 'flex' : 'hidden' }} fixed inset-0 z-50 items-center justify-center bg-black/60 px-4"
      ...
      <div class="w-full max-w-3xl transform rounded-xl bg-white p-6 shadow-xl transition-all dark:bg-gray-800">
        <div class="flex items-start justify-between">
          ...
          <button type="button" wire:click="closeAddProductModal"
        ...
        <div class="mt-4">
          <form wire:submit.prevent="store" class="space-y-4">
            ...
            <div>
              <label for="image"
                class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Gambar</label>
  ...
  <div class="mt-4">
    {{ $products->links('components.layouts.admin.pagination') }}
  </div>
</div>
